...
- **http://158.160.48.231/cash_machine**: веб-узел для принятия POST-запроса для генерации QR-кода.
...
docker-compose up -d
```
- Применение миграций Django и создание администратора:
```
...
- **http://192.168.31.12:8000/cash_machine**: веб-узел для принятия POST-запроса для генерации QR-кода.
