...
3. [Демонстрация проекта](#демонстрация-проекта)
   - [Демонстрация приложения на удалённом сервере](#демонстрация-сервер)
   - [Локальный запуск приложения (с использованием Docker)](#демонстрация-проекта)
   - [Локальный запуск приложения (с использованием Docker)](#демонстрация-проекта)
...
Пользователь может проверить доступные пути API проекта, уже развёрнутом на удалённом сервере, либо развернуть проект на своей локальной машине.
