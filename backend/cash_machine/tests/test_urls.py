...
class TestAppURLs:
    """
    Класс тестов для проверки наличия и доступности URL-эндпоинтов в приложении.

    Этот класс включает в себя тесты, проверяющие наличие и доступность основных URL-эндпоинтов
...
class TestAPIURL:
    ...
    Этот класс включает в себя тесты, проверяющие наличие и доступность URL-эндпоинтов,
    связанных с API, таких, как схема API, Swagger и Redoc.
    """
    def test_schema_url_exists_at_desired_location(self, client):
        ...
        logger.info("Тест наличия эндпоинта `/api/v1/schema/` выполнен успешно.")

    def test_swagger_url_exists_at_desired_location(self, client):
        """
        Проверяет, что эндпоинт `/api/v1/swagger-ui/` доступен по ожидаемому URL.
        ...
        logger.info("Тест наличия эндпоинта `/api/v1/swagger-ui/` выполнен успешно.")
    ...
    def test_redoc_url_exists_at_desired_location(self, client):
        ...
        logger.info("Тест наличия эндпоинта `/api/v1/redoc/` выполнен успешно.")
